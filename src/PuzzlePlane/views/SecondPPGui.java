...
public class SecondPPGui extends JPanel {
	...
	public SecondPPGui(Board b, PuzzlePlaneGui p) {
		...
		this.board = b;
		this.plane = p;
		if(p.puzzleFolderPath != null) draw();
	}
	
	public void reset() {
		setLayout(null);
		if(plane.puzzleFolderPath != null) {
			draw();
		}
	}
	...
	public void draw() {
		...
		traditionalPuzzle1Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("fox")));
		...
		traditionalPuzzle2Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("bird")));
		...
		traditionalPuzzle3Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("rabbit")));
		...
		traditionalPuzzle4Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("cristal")));
		...
		traditionalPuzzle5Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("fish")));
		...
		traditionalPuzzle6Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("duck")));
		...
		traditionalPuzzle7Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath()+ FilePathConfig.puzzleName.get("dontknow")));
		...
		traditionalPuzzle8Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("turtle")));
		...
		traditionalPuzzle9Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("house")));
		...
		traditionalPuzzle10Button.addActionListener(new SelectPuzzleController(board, plane, plane.getPuzzleFolderPath() + FilePathConfig.puzzleName.get("dog")));
