...
public class SecondPPGui extends JPanel {
	...
	public SecondPPGui() {
		...
		*/
		...
		traditionalPuzzle1Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle3Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle4Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle5Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle6Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle7Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle8Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle9Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
		...
		traditionalPuzzle10Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//PuzzlePlaneGui.getContentPane().add(pane)
			}
		});
