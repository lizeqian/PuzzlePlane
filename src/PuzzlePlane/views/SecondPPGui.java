...
public class SecondPPGui extends JPanel {
	...
	public SecondPPGui(Board b, PuzzlePlaneGui p) {
		...
		*/
		...
		traditionalPuzzle1Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/puzzleShapes/0.txt"));
		...
		traditionalPuzzle2Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/puzzleShapes/1.txt"));
		...
		traditionalPuzzle3Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/puzzleShapes/2.txt"));
