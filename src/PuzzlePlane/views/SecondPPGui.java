...
public class SecondPPGui extends JPanel {
	...
	public SecondPPGui(Board b, PuzzlePlaneGui p) {
		...
		traditionalPuzzle1Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + this.puzzleFolderName + FilePathConfig.puzzleName.get("fox")));
		...
		traditionalPuzzle2Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("bird")));
		...
		traditionalPuzzle3Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("rabbit")));
		...
		traditionalPuzzle4Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("cristal")));
		...
		traditionalPuzzle5Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("fish")));
		...
		traditionalPuzzle6Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("duck")));
		...
		traditionalPuzzle7Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("dontknow")));
		...
		traditionalPuzzle8Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("turtle")));
		...
		traditionalPuzzle9Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("house")));
		...
		traditionalPuzzle10Button.addActionListener(new SelectPuzzleController(b, p, "puzzle/" + puzzleFolderName + FilePathConfig.puzzleName.get("dog")));
